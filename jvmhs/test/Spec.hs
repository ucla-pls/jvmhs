...
-- class_hierarchy_test :: TestTree
-- class_hierarchy_test =
--   testCase "Read the class hierarchy" $ do
--     e <- runClassPoolInClassPath classpath $ do
--       _ <- calculateHierarchy ["Simple"]
--       return ()
